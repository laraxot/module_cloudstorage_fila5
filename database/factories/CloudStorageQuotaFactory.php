...
class CloudStorageQuotaFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'limit' => $this->faker->numberBetween(107374182400, 1099511627776),
            'used' => $this->faker->numberBetween(0, 107374182400),
            'remaining' => $this->faker->numberBetween(0, 107374182400),
            ...
            'reset_date' => $this->faker->optional(),
            'last_reset_at' => $this->faker->optional(),
            'next_reset_at' => $this->faker->optional(),
            ...
            'last_warning_sent_at' => $this->faker->optional(),
            'last_critical_sent_at' => $this->faker->optional(),
            'grace_period_days' => $this->faker->numberBetween(0, 30),
            'is_grace_period_active' => $this->faker->boolean(20),
            'grace_period_started_at' => $this->faker->optional(),
            'grace_period_ends_at' => $this->faker->optional(),
            'overage_allowed' => $this->faker->boolean(40),
            'overage_limit' => $this->faker->optional(),
            'overage_used' => $this->faker->optional(),
            'overage_cost_per_gb' => $this->faker->optional(),
            'total_overage_cost' => $this->faker->optional(),
            'settings' => [
                ...
                'retention_days' => $this->faker->optional(),
    ...
    public function withOverage(): static
    {
        return $this->state(fn (array $attributes): array => [
            ...
            'overage_limit' => $this->faker->numberBetween(10737418240, 107374182400),
            'overage_used' => $this->faker->numberBetween(0, 10737418240),

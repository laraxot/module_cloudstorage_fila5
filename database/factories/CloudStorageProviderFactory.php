...
class CloudStorageProviderFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'refresh_token' => $this->faker->optional(),
            'bucket_name' => $this->faker->optional(),
            'region' => $this->faker->optional(),
            'endpoint' => $this->faker->optional(),
            'is_active' => $this->faker->boolean(80),
            'is_default' => $this->faker->boolean(20),
            'priority' => $this->faker->numberBetween(1, 10),
            'max_file_size' => $this->faker->numberBetween(104857600, 107374182400),
            'max_storage_size' => $this->faker->numberBetween(107374182400, 1099511627776),
            'used_storage_size' => $this->faker->numberBetween(0, 107374182400),
            ...
            'last_sync_at' => $this->faker->optional(),
            'last_error_at' => $this->faker->optional(),
            ...
            'settings' => [
                ...
                'lifecycle_policy' => $this->faker->optional(),
    ...
    {
        return $this->state(fn (array $attributes): array => [
            'max_storage_size' => $this->faker->numberBetween(1099511627776, 10995116277760),
        ]);
    }
    ...
    {
        return $this->state(fn (array $attributes): array => [
            'max_storage_size' => $this->faker->numberBetween(107374182400, 536870912000),
        ]);
    }

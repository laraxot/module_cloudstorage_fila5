...
class CloudStorageFolderFactory extends Factory
{
    ...
    public function definition(Faker $faker): array
    {
        return [
            ...
            'encryption_key' => $faker->optional()->sha1(),
            'status' => $faker->randomElement(['active', 'inactive', 'archived', 'deleted']),
            'metadata' => [
                'description' => $faker->optional()->sentence(),
                'tags' => $faker->optional()->words(3, true),
                'color' => $faker->optional()->hexColor(),
                'icon' => $faker->optional()->word(),
                'permissions' => $faker->optional()->json(),
            ...
            'settings' => [
                ...
                'delete_after_days' => $faker->optional()->numberBetween(1, 365),
                'max_file_size' => $faker->optional()->numberBetween(1024, 1073741824),
                'allowed_file_types' => $faker->optional()->words(5, true),
                'max_files_count' => $faker->optional()->numberBetween(10, 10000),
                'sync_interval' => $faker->optional()->numberBetween(60, 86400),
                'backup_retention_days' => $faker->optional()->numberBetween(1, 365),
                'compression_level' => $faker->optional()->numberBetween(1, 9),
                'encryption_algorithm' => $faker->optional()->randomElement(['AES-256', 'AES-128', 'ChaCha20']),
                'cdn_enabled' => $faker->boolean(60),
                'versioning_enabled' => $faker->boolean(50),
                'lifecycle_policy' => $faker->optional()->json(),
            ],
            'user_id' => $faker->numberBetween(1, 100),
            'created_at' => $faker->dateTimeBetween('-1 year', 'now'),
            'updated_at' => $faker->dateTimeBetween('-6 months', 'now'),
            'last_accessed_at' => $faker->optional()->dateTimeBetween('-1 year', 'now'),
    ...
    public function withManyFiles(): static
    {
        return $this->state(fn (array $attributes) => [
            ...
            'total_size' => $this->faker->numberBetween(1073741824, 107374182400),
        ]);
    }
    ...
    public function withFewFiles(): static
    {
        return $this->state(fn (array $attributes) => [
            ...
            'total_size' => $this->faker->numberBetween(0, 104857600),
        ]);
    }
    ...
    public function large(): static
    {
        return $this->state(fn (array $attributes) => [
            ...
            'total_size' => $this->faker->numberBetween(107374182400, 1073741824000),
        ]);
    }
